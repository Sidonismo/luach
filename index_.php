...

{
				 ...
				 $prvniMonthName = jdmonthname ( $prvniMesic, 4 );
				 $druhyMonthName = jdmonthname ( $druhyMesic, 4 );
				 echo $hebrewDay . ". &nbsp;" . $hebrewMonthName . "&nbsp;" . $hebrewYear."</p></div><ul>";
...
<?php
?>
</span><FORM METHOD="GET" ACTION="index.php" class="form-table"> 
<TABLE width=400 border=0 cellspacing=0 cellpadding=5>
<TR><TD>
Místo / Destination:<br>
...
<TR><TD>
 <!-- Datepicker -->
 Datum / Date: <br>
<input type="text" NAME="datum" id="flex3" title="Tip pro přepnutí v kalendáři na předchozí nebo následující rok- klikněte v horní liště kalendář na měsíc nebo rok a následně použijte klávesovou zkratku ALT+page up/down" VALUE="<?php echo date("j.n.Y", mktime( 0, 0, 0, $mesic, $den, $rok ) ); ?>">
...
<?php
echo "<div class=\"HebDatum\"><p>".$den . ". " . $mesic2 . " " . $rok . " v " . $activelocation. "</p><p>";
...
echo "<li>Slunce vychází v " . $vychod . " a zapadá v " . $zapad." a pravé poledne je v:" . $val9."</li>";
...
echo "<li>Východ tří malých hvězd:" . $havdalaNahoru . "\n</li>";
