...
$db = $client->myNewDB;
$collection = $db->myNewCollection2;
$document1 = $collection->findOne(['_id' => new MongoDB\BSON\ObjectID('600999072ce6a85e771514d4')]);
$document2 = $collection->findOne(['x' => 1]);
?>
<h1>Document: <?php var_dump($document1, $document2); ?></h1>